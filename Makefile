# This Makefile is for the Data::Polymorph extension to perl.
#
...
#     ABSTRACT => q[Yet another approach for polymorphism.]
#     AUTHOR => q[lieutar <lieutar@1dk.jp>]
#     DIR => []
#     DISTNAME => q[Data-Polymorph]
#     NAME => q[Data::Polymorph]
#     NO_META => q[1]
#     PL_FILES => {  }
#     PREREQ_PM => { Test::More=>q[0], ExtUtils::MakeMaker=>q[6.44] }
#     VERSION => q[0.01]
#     clean => { FILES=>q[META.yml] }
#     dist => { PREOP=>q[$(PERL) -I. "-MModule::Install::Admin" -e "dist_preop(q($(DISTVNAME)))"] }
#     test => { TESTS=>q[t/00-load.t t/10-normal.t t/boilerplate.t t/dependencies.t t/perlcritic.t t/pod-coverage.t t/pod.t] }
...
H_FILES  = 
MAN1PODS = 
MAN3PODS = lib/Data/Polymorph.pm
...
TO_INST_PM = lib/Data/Polymorph.pm

PM_TO_BLIB = lib/Data/Polymorph.pm \
...
DISTNAME = Data-Polymorph
DISTVNAME = Data-Polymorph-0.01
...
manifypods : pure_all  \
	lib/Data/Polymorph.pm
	$(NOECHO) $(POD2MAN) --section=3 --perm_rw=$(PERM_RW) \
	  lib/Data/Polymorph.pm $(INST_MAN3DIR)/Data.Polymorph.$(MAN3EXT) 
...
TEST_FILE = test.pl
TEST_FILES = t/00-load.t t/10-normal.t t/boilerplate.t t/dependencies.t t/perlcritic.t t/pod-coverage.t t/pod.t
TESTDB_SW = -d
...
ppd :
	...
	$(NOECHO) $(ECHO) '    <ABSTRACT>Yet another approach for polymorphism.</ABSTRACT>' >> $(DISTNAME).ppd
...
pm_to_blib : $(TO_INST_PM)
	$(NOECHO) $(ABSPERLRUN) -MExtUtils::Install -e 'pm_to_blib({@ARGV}, '\''$(INST_LIB)/auto'\'', '\''$(PM_FILTER)'\'')' -- \
	  lib/Data/Polymorph.pm blib/lib/Data/Polymorph.pm 
